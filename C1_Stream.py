...
def load_my_data(file_choice):
    ...
    paths = {
        ...
        "Oddech co 10s": "EKG+oddech_co_10_sek.txt"
    }
...
wybor = st.sidebar.selectbox(
    "Wybierz rodzaj badania:",
    ["Spoczynkowe", "Wysiłkowe", "Oddech standardowy", "Oddech co 10s"]
)

# Wywołanie funkcji - dane trafią do zmiennej df, której używa reszta kodu
df = load_my_data(wybor)
tab1, tab2 = st.tabs(["📊 HRV", "🫁 Oddech + EKG"])
